...
namespace Huangbo.AStarPetri.Test
{
    class MainClass
    {
        ...
        static void Main(string[] args)
        {
            ...
            int[] hMethods = new int[]  {12};//所用启发函数h  //the used heuristic function, for example, if you want to use h=0, you input 0 here and if you want to use h=h_H, you input 7 here.
            //h0 = 0;
